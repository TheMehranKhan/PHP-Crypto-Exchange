...
Datafeeds.TradingViewDatafeed = function(datafeedURL, updateFrequency) {
...
Datafeeds.TradingViewDatafeed.prototype.defaultConfiguration = function() {
	return {
		...
		exchanges: [],
		symbolsTypes: [],
		supportedResolutions: ["5", "15", "30", "120", "240", "360", "1440"/*, "D", "2D", "4D", "W", "2W", "M"*/]
	};
};

Datafeeds.TradingViewDatafeed.prototype.getServerTime = function(callback) {
...
Datafeeds.TradingViewDatafeed.prototype.on = function(event, callback) {
...
Datafeeds.TradingViewDatafeed.prototype._fireEvent = function(event, argument) {
	if (this._callbacks.hasOwnProperty(event)) {
...
Datafeeds.TradingViewDatafeed.prototype.onInitialized = function() {
	this._initializationFinished = true;
	this._fireEvent('initialized');
};

Datafeeds.TradingViewDatafeed.prototype._logMessage = function(message) {
...
Datafeeds.TradingViewDatafeed.prototype._send = function(url, params) {
	var request = url;
	if (params) {
...
Datafeeds.TradingViewDatafeed.prototype._initialize = function() {
	var that = this;
...
Datafeeds.TradingViewDatafeed.prototype.onReady = function(callback) {
	var that = this;
...
Datafeeds.TradingViewDatafeed.prototype._setupWithConfiguration = function(configurationData) {
...
Datafeeds.TradingViewDatafeed.prototype.getMarks = function(symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
};

Datafeeds.TradingViewDatafeed.prototype.getTimescaleMarks = function(symbolInfo, rangeStart, rangeEnd, onDataCallback, resolution) {
};

Datafeeds.TradingViewDatafeed.prototype.searchSymbols = function(searchString, exchange, type, onResultReadyCallback) {
	onResultReadyCallback([]);
};

Datafeeds.TradingViewDatafeed.prototype.resolveSymbol = function(symbolName, onSymbolResolvedCallback, onResolveErrorCallback) {
	var that = this;
	...
	if (!this._initializationFinished) {
		...
		setTimeout(function () {
			var ticker = symbolName.toUpperCase();
			onSymbolResolvedCallback({
				...
				ticker: ticker,
				type: 'stock',
				supported_resolutions: ["5", "15", "30", "120", "240", "360", "1440"/*, "D" , "2D", "4D", "W", "2W", "M"*/]
				// has_daily: true,
...
Datafeeds.TradingViewDatafeed.prototype.registerGetBarsHandler = function(handler) {
	this._getBarsHandler = handler;
}

Datafeeds.TradingViewDatafeed.prototype.getBars = function(symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback) {
	...
	var that = this;
	setTimeout(function () {
		if (that._getBarsHandler) {
			that._getBarsHandler(symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback);
		} else {
			var sym1 = {
				s: 'ok',
				t: [1483315200, 1483401600, 1483488000, 1483574400, 1483660800],
				o: [ 2,  4,  6,  8, 10],
				h: [10, 20, 30, 40, 50],
				l: [ 1,  2,  3,  4,  5],
				c: [ 3,  5,  7,  6, 11]
			...
			var data = symbolInfo.name == "AAPL" ? sym1 : sym2;
...
Datafeeds.TradingViewDatafeed.prototype.subscribeBars = function(symbolInfo, resolution, onRealtimeCallback, listenerGUID, onResetCacheNeededCallback) {
};

Datafeeds.TradingViewDatafeed.prototype.unsubscribeBars = function(listenerGUID) {
};

Datafeeds.TradingViewDatafeed.prototype.calculateHistoryDepth = function(period, resolutionBack, intervalBack) {
};

Datafeeds.TradingViewDatafeed.prototype.getQuotes = function(symbols, onDataCallback, onErrorCallback) {
};

Datafeeds.TradingViewDatafeed.prototype.subscribeQuotes = function(symbols, fastSymbols, onRealtimeCallback, listenerGUID) {
};

Datafeeds.TradingViewDatafeed.prototype.unsubscribeQuotes = function(listenerGUID) {
};
...
if (typeof module !== 'undefined' && module && module.exports) {
	module.exports = {
		TradingViewDatafeed: Datafeeds.TradingViewDatafeed,
	};
}
