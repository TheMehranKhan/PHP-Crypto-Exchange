    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <h2 class="text-white mt-0"><span class="cmb-single-line-editable-text">We've got what you need!</span></h2>
                ...
                <a class="btn btn-light btn-xl js-scroll-trigger" href="#services"><span class="cmb-single-line-editable-text">Get Started!</span></a>
            </div>
        </div>
    </div>
</section>`
...
cmbAllElements['cmb_tab'] = {
    ...
    <ul class="tab-nav d-flex">
        <li class="cmb_tab_item tab-active"><a href="#"><span class="cmb-single-line-editable-text">Tab 1</span></a></li>
        <li class="cmb_tab_item"><a href="#"><span class="cmb-single-line-editable-text">Tab 2</span></a></li>
    </ul>
...
cmbAllElements['cmb_tab_item'] = {
    ...
    elementType: 'static-layout',
    settings: {},
    html: ['.tab-nav', '<li class="cmb_tab_item"><a href="#"><span class="cmb-single-line-editable-text">New Tab</span></a></li>'],
    ...
    html: `<div class="cmb_tagline_box cmb-element">
        <div class="cmb-tagline-box-container d-md-block flex-column d-flex clearfix">
            <div class="order-2 float-md-right flex-grow-12 my-2 ml-md-3">
                <a href="#" class="btn btn-success d-block cmb-tagline-btn"><span class="cmb-single-line-editable-text">Tagline Box Button</span></a>
            </div>
            <div class="order-1">
...
cmbAllElements['cmb_port-icon'] = {
    allowedParent: ['cmb_column'],
    addButtonText: 'Port Icon',
    title: 'Port Icon',
    icon: '<i class="cm cm-content-box"></i>',
    elementTabName: 'component',
    elementType: 'static-layout',
            ...
            options: [
                {
                    ...
                    'content-color': {
                        ...
                        attribute: 'style',
                        styleName: 'color',
                        childItem: '.cmb-port-icon-content'
                    },
                    'dark-content-color': {
                        title: 'Content Text Color (Dark)',
                        subTitle: 'Select a color',
    ...
    html: `<div class="portfolio_list cmb_port-icon py-3">
    <div class="media">
        <div class="port-icon">
        ...
        <div class="media-body">
            <h4 class="mt-0 cmb-icon-box-title"><span class="cmb-single-line-editable-text">Security Wallet</span></h4>
            <p class="cmb-port-icon-content"><span class="cmb-single-line-editable-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae dolore eaque.</span></p>
            <p><a href="#" class="btn btn-sm cmb-port-icon-btn"><span class="cmb-single-line-editable-text">Visit Now</span></a></p>
        </div>
    </div>
</div>`
};

cmbAllElements['cmb_card_box'] = {
    allowedParent: ['cmb_column'],
    addButtonText: 'Card Box',
    title: 'Card Box',
    icon: '<i class="cm cm-content-box"></i>',
    elementTabName: 'component',
    elementType: 'static-layout',
            ...
            options: [
                {
                    ...
                    'content-color': {
                        ...
                        attribute: 'style',
                        styleName: 'color',
                        childItem: '.cmb-card-box-content'
                    },
                    'dark-content-color': {
                        title: 'Content Text Color (Dark)',
                        subTitle: 'Select a color',
    ...
    html: `<div class="card trade-app-content cmb_card_box py-3">
    <div class="card-body">
        <span class="card-icon-box">
            <i class="fa custom-icon"></i>
        </span>
        <h4 class="mt-0 card-title cmb-card-box-title"><span class="cmb-single-line-editable-text">Mobile</span></h4>
            <p><span class="cmb-single-line-editable-text">All the power of Tradio's cryptocurrency exchange, in the palm of your hand. Download the Tradio mobile crypto trading app today </span></p>
            <a href="#" class="btn btn-sm cmb-port-icon-btn"><span class="cmb-single-line-editable-text">Know More<i class="la la-arrow-right"></i></span></a>
    </div>
</div>`
};

cmbAllElements['cmb_promo_box'] = {
    allowedParent: ['cmb_column'],
    addButtonText: 'Promo Box',
    title: 'Promo Box',
    icon: '<i class="cm cm-content-box"></i>',
    elementTabName: 'component',
    elementType: 'static-layout',
    ...
    html: `<div class="promo cmb_promo_box py-3">
    <div class="promo-content">
        <div class="promo-content-img">
            <img class="img-fluid custom-svg" src="/storage/images/cart-icons/protect.svg" alt="">
        </div>
        <h3><span class="cmb-single-line-editable-text">Secure storage</span></h3>
        <p><span class="cmb-single-line-editable-text"> We store the vast majority of the digital assets in secure offline storage.</span></p>
    </div>
</div>`
};
           ...
           <!--HEAD PRICE DETAIL START-->
                ...
                <div class="cmb_feature_list">
                    <ul class="cmb_pricing_feature_ul pt-3">
                        <li class="cmb_pricing_feature_item"><strong><span class="cmb-single-line-editable-text">2GB</span></strong> <span class="cmb-single-line-editable-text">Bandwidth</span></li>
                        <li class="cmb_pricing_feature_item"><strong><span class="cmb-single-line-editable-text">150GB</span></strong> <span class="cmb-single-line-editable-text">Storage</span></li>
                        <li class="cmb_pricing_feature_item"><strong><span class="cmb-single-line-editable-text">12</span></strong> <span class="cmb-single-line-editable-text">Accounts</span></li>
                        <li class="cmb_pricing_feature_item"><strong><span class="cmb-single-line-editable-text">7</span></strong> <span class="cmb-single-line-editable-text">Host Domain</span></li>
                        <li class="cmb_pricing_feature_item"><strong><span class="cmb-single-line-editable-text">24/7</span></strong> <span class="cmb-single-line-editable-text">Support</span></li>
                    </ul>
                </div>
                <!--//FEATURE LIST END-->
                ...
                <div class="cmb_price_btn clearfix">
                    <a href="#"><span class="cmb-single-line-editable-text">Sign up</span></a>
                </div>
                <!--//BUTTON END-->
        </div>`,
};
cmbAllElements['cmb_pricing_feature_item'] = {
    ...
    avoidableTabs: ['position', 'background', 'design'],
    html: `<li class="cmb_pricing_feature_item"><strong><span class="cmb-single-line-editable-text">2GB</span></strong> <span class="cmb-single-line-editable-text">Bandwidth</span></li>`,
};
