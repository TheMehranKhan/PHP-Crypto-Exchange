...
use App\Services\Orders\ProcessRobotOrderService;
...
class ProcessOrderJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        } else if ($this->order->user_id == "07178aa8-bbd6-4f8b-9fbf-48711485ab8d") {
            app(ProcessRobotOrderService::class, [$this->order])->process();
        } else {
