...
if (!function_exists('binance_deposit_status')) {
    function binance_deposit_status($input = null)
    {
        $output = [
            STATUS_PENDING => __('Pending'),
            STATUS_PROCESSING => __('Processing'),
...
if (!function_exists('id_type')) {
    function kyc_type($input = null)
    {
        $output = [
            ...
            KYC_ID_ANALYZER => __('ID Analyzer'),
        ];
    ...
    if (!function_exists('coin_types')) {
        function coin_types($input = null)
        {
            $output = [
                ...
                COIN_TYPE_TRC10 => __('TRC10'),
                COIN_TYPE_TRC20 => __('TRC20'),
                COIN_TYPE_BEP20 => __('BEP20'),
            ];
    ...
    if (!function_exists('crypto_apis')) {
        function crypto_apis($input = null)
        {
            $output = [
                ...
                API_BINANCE => __('Binance API'),
                API_BEP20 => __('BEP20 API'),
                API_TRON => __('Tron API'),
                API_TRC10 => __('TRC10 API'),
                API_TRC20 => __('TRC20 API'),
                API_OMNI_LAYER => __('Omni Layer'),
                API_INTERNAL => __('Internal')
            ];
    ...
    if (!function_exists('fiat_apis')) {
        function fiat_apis($input = null)
        {
            $output = [
                API_BANK => __('Bank'),
                API_ADVCASH => __('ADV Cash'),
                API_PAYPAL => __('Paypal'),
                API_VANDAR => __('Vandar'),
                API_IDPAY => __('Idpay'),
                API_PAYIR => __('Payir'),
                API_ZARINPAL => __('Zarinpal'),
                API_MELLAT => __('Mellat'),
            ];
