...
class UsersController extends Controller
{
    ...
    {
        $parameters = $request->only(['first_name', 'last_name', 'address', 'assigned_role', 'email', 'mobile', 'username', 'is_email_verified', 'is_financial_active', 'status', 'is_accessible_under_maintenance']);
        ...
        if ($response[RESPONSE_STATUS_KEY]) {
            ...
            if (env('QUEUE_CONNECTION', 'sync') === 'sync') {
                GenerateUserWalletsJob::dispatchSync($user);
            } else {
