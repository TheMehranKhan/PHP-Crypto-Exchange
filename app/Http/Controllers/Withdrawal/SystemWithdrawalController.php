...
class SystemWithdrawalController extends Controller
{
    ...
    public function store(WithdrawalRequest $request, $wallet)
    {
        ...
        $params = [
            ...
            'api' => in_array($wallet->coin->type, [COIN_TYPE_CRYPTO, COIN_TYPE_ERC20, COIN_TYPE_BEP20, COIN_TYPE_TRC20, COIN_TYPE_TRC10]) ? $wallet->coin->payment_service['methods'] : $request->get('api'),
