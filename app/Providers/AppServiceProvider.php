...
use App\Override\Api\ADVCashApi;
use App\Override\Api\BEP20Api;
use App\Override\Api\BinanceApi;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->bind("ADVCashApi", function ($app, $parameters) {
            return new ADVCashApi($parameters[0]);
        });
        ...
        $this->app->bind("BinanceApi", function ($app, $parameters) {
            return new BinanceApi($parameters[0]);
        });

        $this->app->bind("BEP20Api", function ($app, $parameters) {
            return new BEP20Api($parameters[0]);
        });

        $this->app->bind("TRC20Api", function ($app, $parameters) {
            return new TRC20Api($parameters[0]);
        });

        $this->app->bind("TRC10Api", function ($app, $parameters) {
            return new TRC10Api($parameters[0]);
        });

        $this->app->bind("TronApi", function ($app, $parameters) {
            return new TronApi($parameters[0]);
        });
        ...
        $this->app->bind(StakeService::class, function ($app, $parameters) {
            return new StakeService($parameters[0]);
        });
