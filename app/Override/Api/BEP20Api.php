...
class BEP20Api
{
    ...
    public function generateAddress(string $passphrase = ""): array
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][generateAddress]");
        }
    ...
    public function approve(float $amount, string $owner, string $passphrase): bool
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][approve]");
        }
        return false;
    }
    ...
    public function sendToAddress(string $to, float $amount, $gasPrice = null, $gasLimit = null): array
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][sendToAddress]");
        }
        return [
    ...
    public function getBalance(string $address): float
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][getBalance]");
        }
        return 0;
    }
    ...
    public function sendETHToAddress(string $to, float $amount, $gasPrice = null, $gasLimit = null): array
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20][sendETHToAddress]");
        }
        return [
            RESPONSE_STATUS_KEY => false
        ];
    ...
    public function getETHBalance(string $wallet = ""): float
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][getETHBalance]");
        }
        return 0;
    }
    ...
    public function validateAddress(string $address): bool
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][validateAddress]");
        }
        return false;
    }
    ...
    public function getTransaction(string $txnId): array
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][getTransaction]");
        }
    ...
    public function getTransactionStatus(string $txnId): bool
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][getTransactionStatus]");
        }
        return false;
    }
    ...
    public function gasPrice(): array
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BEP20Api][gasPrice]");
        }
