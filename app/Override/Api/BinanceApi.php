...
class BinanceApi
{
    ...
    public function generateAddress(string $passphrase = ""): array
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BinanceApi][generateAddress]");
        }
    ...
    public function sendToAddress(string $to, float $amount, string $from = '', string $password = '', $gasPrice = null, $gasLimit = null): array
    {
        ...
        try {
            ...
            Logger::error($exception, "[FAILED][BinanceApi][sendToAddress]");
        }
        return [
    ...
    public function getBalance(string $wallet = ""): float
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BinanceApi][getBalance]");
        }
        return 0;
    }
    ...
    public function validateAddress(string $address): bool
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BinanceApi][validateAddress]");
        }
        return false;
    }
    ...
    public function getTransaction(string $txnId): array
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BinanceApi][getTransaction]");
        }
    ...
    public function gasPrice()
    {
        try {
            ...
            Logger::error($exception, "[FAILED][BinanceApi][gasPrice]");
        }
        return ['error' => 'No transactions found.'];
    }
