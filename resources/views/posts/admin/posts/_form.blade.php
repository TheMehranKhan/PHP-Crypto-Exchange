...
{{--content--}}
<div class="form-group mb-3">
    <label for="content" class="control-label required">{{ __('Content') }}</label>
    {{ Form::textarea('content',  old('content', $post->content ?? null), ['class'=> form_validation($errors, 'content'), 'id' => 'content']) }}
