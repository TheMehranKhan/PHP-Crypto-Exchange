                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{ __('Deposit Details') }}</h4>
                                        ...
                                        <div class="card lf-toggle-bg-card lf-toggle-border-color p-4">
                                                    ...
                                                    <div class="row">
                                                        @foreach($systemBanks as $systemBank)
                                                            <div class="{{ count($systemBanks) == 1? 'col-md-12': 'col-md-6' }}">
                                                                <label class="d-block lf-cursor-pointer h-100"
                                                                       for="{{ $systemBank->id }}">
                                            ...
                                            <span class="btn btn-sm btn-success btn-file">
                                                ...
                                                {{ Form::file('receipt', ['class' => 'btn btn-default border','id' => 'receipt']) }}
                                                    ...
                                                    <span class="invalid-feedback"
                                                          data-name="receipt">{{ $errors->first('receipt') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="d-flex">
                                                            ...
                                                            <figure>
                                                                <img class="img-fluid"
                                                                     src="{{ get_deposit_receipt($deposit->receipt) }}"
                                                                     alt="">
                                                            </figure>
                                                        </div>
                                                    </div>
