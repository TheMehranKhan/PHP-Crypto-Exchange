                                ...
                                @auth
                                    ...
                                    <li>
                                        <div class="btn-group lf-user-notification">
                                            ...
                                            @if(!empty($userNotifications['list']->count()))
                                                <div class="dropdown-menu dropdown-menu-sm-left dropdown-menu-md-right" id="notificationDrop">
                                        <span
                                    ...
                                    <li>
                                        <div class="btn-group lf-user-dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-sm-left dropdown-menu-md-right" id="profileDrop">
