                            ...
                            <table class="table table-borderless">
                                ...
                                @if($withdrawal->api === API_BANK)
                                    <tr>
                                        ...
                                        <td>{{ get_bank_account_by_id($withdrawal->bank_account_id)->iban }}</td>
                                        <th class="pl-0">{{ __('SWIFT / BIC') }}</th>
                                        <td>{{ get_bank_account_by_id($withdrawal->bank_account_id)->swift }} - {{ get_bank_account_by_id($withdrawal->bank_account_id)->bank_name }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <th class=" pl-0">
