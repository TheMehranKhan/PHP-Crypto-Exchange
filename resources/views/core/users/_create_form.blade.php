...
<div class="form-group mb-1">
    <label for="email" class="col-form-label text-right required">{{ __('mobile') }}</label>
    <div>
        <input dir="ltr" id="phone"
               type="text"
               class="{{ form_validation($errors, 'mobile') }} lf-toggle-bg-input lf-toggle-border-color typeleft"
               name="mobile"
               value="{{ old('mobile') }}"
        >
