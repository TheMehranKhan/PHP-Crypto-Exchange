        ...
        <div class="row">
            <div class="offset-md-2 col-md-8">
                @component('components.card', [
                    ...
                    {{ Form::open(['route'=>'user-banks.store', 'method' => 'post', 'class'=>'form-horizontal validator-form', 'id' => 'bankForm']) }}
                    @include('user_bank_managements.admin._form')
                    {{ Form::close() }}
                @endcomponent
            </div>
        </div>
