    ...
    <div class="container my-5">
        @component('components.coin', ['coin' => $coin])
            ...
            <div class="form-group">
                ...
                @if(in_array($coin->type, [COIN_TYPE_CRYPTO,COIN_TYPE_ERC20,COIN_TYPE_BEP20,COIN_TYPE_TRC10,COIN_TYPE_TRC20,COIN_TYPE_BEP20]))
    ...
    <script>
        ...
        new Vue({
            ...
            data: {
                ...
                showPropertyId: "{{old('api', (isset($coin->api['selected_apis']) && $coin->type === COIN_TYPE_CRYPTO) ? $coin->api['selected_apis'] : '')}}" === "{{API_OMNI_LAYER}}"
            },
            methods: {
