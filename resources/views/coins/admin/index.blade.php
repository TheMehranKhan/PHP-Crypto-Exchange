...
@section('title', $title)
@section('route', $isRoute =true, $routeName = 'Add New Coin', $route = 'coins.create')
@section('content')
                                ...
                                <td class="lf-action text-right">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            @if(has_permission('coins.reset-addresses') && in_array($coin->type,[COIN_TYPE_CRYPTO, COIN_TYPE_ERC20, COIN_TYPE_BEP20, COIN_TYPE_TRC10,COIN_TYPE_TRC20]))
