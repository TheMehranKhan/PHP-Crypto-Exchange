    ...
    <div class="container py-5" id="app">
        <div class="row">
            <div class="col-md-4 text-center text-light">
                ...
                <div class="bg-secondary p-3 lf-toggle-border-color border-top-0 border">
                ...
                <div class="card lf-toggle-border-color lf-toggle-bg-card">
                    <div class="card-body">
                        @if($wallet->coin->withdrawal_status == ACTIVE)
                            ...
                            @if(in_array($wallet->coin->type,[COIN_TYPE_CRYPTO, COIN_TYPE_ERC20,COIN_TYPE_BEP20,COIN_TYPE_TRC20]))
