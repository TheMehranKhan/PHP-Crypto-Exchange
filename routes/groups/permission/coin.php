...
use App\Http\Controllers\Coin\AdminCoinBonusController;
use App\Http\Controllers\Coin\AdminCoinStakeOptionController;
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('coins/{coin}/bonus/edit', [AdminCoinBonusController::class, 'edit'])
        ->name('coins.bonus.edit');
    Route::put('coins/{coin}/bonus/update', [AdminCoinBonusController::class, 'update'])
        ->name('coins.bonus.update');
    Route::delete('coins/bonus/{bonus}/delete', [AdminCoinBonusController::class, 'destroy'])
        ->name('coins.bonus.destroy');

    Route::get('coins/{coin}/stake/edit', [AdminCoinStakeOptionController::class, 'edit'])
        ->name('coins.stake.edit');
    Route::put('coins/{coin}/stake/update', [AdminCoinStakeOptionController::class, 'update'])
        ->name('coins.stake.update');
    Route::delete('coins/stake/{stake}/delete', [AdminCoinStakeOptionController::class, 'destroy'])
        ->name('coins.stake.destroy');
